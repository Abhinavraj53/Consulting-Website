...
const categoryContent: Record<string, CategoryContent> = {
  ...
  "Funding Solutions": {
    audience: "companies planning collateral-free credit, term loans or investor funding",
...
const serviceHeroOverrides: Record<string, string> = {
  "12a-and-80g-registration": "/epeno-offers/12a-and-80g-registration.webp",
  "agri-preneurs": "/service-heroes/agri-preneurs-google.jpg",
  "bhaskar-id": "/service-heroes/bhaskar-id.jpg",
  "cgtmse-loan": "/service-heroes/cgtmse-loan-google.jpg",
  "copyright-registration": "/epeno-offers/copyright-registration.webp",
  "credit-guarantee-scheme-for-startups-cgss": "/service-heroes/startup-india-certification.jpg",
  "financial-deck": "/service-heroes/financial-deck.jpg",
  "fssai-certificate": "/epeno-offers/fssai-certificate.webp",
  "gem-registration": "/epeno-offers/gem-registration.webp",
  "gst-compliances": "/epeno-offers/gst-compliances.png",
  "gst-registration-and-certificate": "/epeno-offers/gst-registration-and-certificate.png",
  "gujarat-innovators": "/service-heroes/gujarat-innovators.jpg",
  "iec-certificate": "/epeno-offers/iec-certificate.webp",
  "income-tax-compliances": "/epeno-offers/income-tax-compliances.png",
  "investor-deck": "/service-heroes/investor-deck.jpg",
  "iso-certificate": "/epeno-offers/iso-certificate.png",
  "limited-liability-partnership": "/epeno-offers/limited-liability-partnership.webp",
  "msme-design": "/service-heroes/msme-design-schemes.png",
  "msme-loan": "/service-heroes/working-capital-cgtmse-loan.jpg",
  "mudra-loan": "/service-heroes/mudra-loan-seekho.webp",
  "naiff": "/service-heroes/naiff-infrastructure.jpg",
  "ngo-darpan": "/epeno-offers/ngo-darpan.webp",
  "nidhi-prayas": "/service-heroes/nidhi-prayas.jpg",
  "nsic-certification": "/epeno-offers/nsic-certification.webp",
  "one-person-company-registration": "/epeno-offers/one-person-company-registration.webp",
  "partnership-firm-registration-rof": "/epeno-offers/partnership-firm-registration-rof.webp",
  "patent-registration": "/epeno-offers/patent-registration.png",
  "pmegp-loan": "/service-heroes/pmegp-google.jpg",
  "private-limited-company-incorporation": "/epeno-offers/private-limited-company-incorporation.webp",
  "roc-compliances-for-llp": "/epeno-offers/roc-compliances-for-llp.png",
  "roc-compliances-for-pvt-ltd": "/epeno-offers/roc-compliances-for-pvt-ltd.png",
  "section-8-company": "/epeno-offers/section-8-company.webp",
  "seed-fund": "/service-heroes/seed-fund-startup-india.jpg",
  "seed-support-scheme": "/service-heroes/seed-support-scheme.jpg",
  "shram-suvidha-registration": "/epeno-offers/shram-suvidha-registration.webp",
  "startup-india-certification": "/epeno-offers/startup-india-certification.png",
  "tax-exemption-certificate": "/epeno-offers/tax-exemption-certificate.webp",
  "tide-idea-2-0": "/service-heroes/tide-idea-2-0.jpg",
  "trademark-registration": "/epeno-offers/trademark-registration.png",
  "udyam-registration": "/epeno-offers/udyam-registration.webp",
  "zed-certificate": "/epeno-offers/zed-certificate.webp",
}
