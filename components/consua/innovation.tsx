    ...
    <section className="relative overflow-hidden bg-navy py-24 text-navy-foreground">
      <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-2">
        ...
        <div className="group relative overflow-hidden rounded-2xl">
          <img
            src="/service-heroes/cgtmse-loan.jpg"
            alt="Epeno Advisory consultant on the phone"
            className="aspect-[16/11] w-full object-cover object-center shadow-xl transition-transform duration-700 group-hover:scale-[1.04]"
          />
