export const siteStats = {
  ...
  serviceOptions: { value: 100, suffix: "+", label: "Service Options" },
  projectsSupported: { value: 2000, suffix: "+", label: "Projects Supported" },
  upcomingProjects: { value: 100, suffix: "+", label: "Upcoming Projects" },
  startupRecognitions: { value: 1500, suffix: "+", label: "Startup India Recognition" },
  coreServiceCategories: { value: 40, suffix: "+", label: "Core Services" },
